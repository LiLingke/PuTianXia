...
public class Activity01 extends Activity implements OnScrollListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		weizhi_back=(ImageView) findViewById(R.id.weizhi_back);
		weizhi_back.setOnClickListener(new OnClickListener() {
...
option.setEnableSimulateGps(false);//可选，默认false，设置是否需要过滤gps仿真结果，默认需要
	...
	public class ListAdapter extends BaseAdapter {
		...
		@Override
		public int getViewTypeCount() {//getViewTypeCount这个方法告诉ListView我共有多少种item
			return VIEW_TYPE;
		}

		@Override
		public int getItemViewType(int position) {//getItemViewType方法告诉ListView每行该显示哪种item，并且该方法中返回的type类型必须为整数且不能大于getViewTypeCount返回的数
